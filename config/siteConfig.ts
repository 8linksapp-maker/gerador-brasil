...
export const defaultSiteData: SiteData = {
  ...
  settings: {
    ...
    colors: { 
      primary: '#dc2626', // Sky 500
      secondary: '#ea580c', // Slate 500
      accent: '#facc15', // Amber 500
  ...
  services: [
    ...
    },
    {
      ...
      benefits: [
        'Suporta picos de energia',
        'Tanque de alta capacidade',
    ...
    },
    {
      ...
      benefits: [
        'Super silenciado (<75dB)',
        'Estabilidade para equipamentos sensíveis',
        'Visual discreto',
        'Cabos emborrachados',
      ],
      howItWorks: [
    ...
    },
    {
      ...
      benefits: [
        'Técnico presencial (stand-by)',
        'Passadeiras de segurança',
        'Cabos extras inclusos',
